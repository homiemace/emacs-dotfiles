...
(use-package
 ...
 :ensure t
 :custom
 (org-roam-directory (expand-file-name "~/emacs-dotfiles/wiki-v2"))
 (org-roam-completion-everywhere t)
 (org-roam-capture-templates
  '(("j"
     "javascript"
     plain
     (file "~/emacs-dotfiles/wiki-v2/templates/javascript-template.org")
     :if-new
     (file+head
      "javascript/${slug}.org"
      "#+title: ${title}\n#+filetags: :javascript:\n\n")
    ...
    ("s"
     "svelte"
     plain
     (file "~/emacs-dotfiles/wiki-v2/templates/svelte-template.org")
     :if-new
     (file+head
      "svelte/${slug}.org"
      "#+title: ${title}\n#+filetags: :svelte:\n")
    ...
    ("c"
     "css"
     plain
     (file "~/emacs-dotfiles/wiki-v2/templates/css-template.org")
     :if-new
     (file+head
      "css/${slug}.org" "#+title: ${title}\n#+filetags: :css:\n\n")
     :unnarrowed t)
    ("w"
     "webapis"
     plain
     (file "~/emacs-dotfiles/wiki-v2/templates/webapis-template.org")
     :if-new
     (file+head
      "webapis/${slug}.org"
      "#+title: ${title}\n#+filetags: :webapis:\n\n")
    ...
    ("y"
     "cybersecurity"
     plain
     (file "~/emacs-dotfiles/wiki-v2/templates/cybersec-template.org")
     :if-new
     (file+head
      "cybersecurity/${slug}.org"
...
#+begin_src emacs-lisp
  (defvar my/wikis
    '((javascript
      ...
      (cybersecurity :dir "wiki/cybersecurity" :tag "cybersecurity" :lang "text" :key "y")
      (webapis
       :dir "wiki/webapis"
       :tag "webapis"
       :lang "javascript"
