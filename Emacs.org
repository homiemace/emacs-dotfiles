...
Configure Org Babel for code execution and auto-tangling.

** Babel Languages

Enable languages for code block execution in Org mode.
...
Personal reference for JavaScript concepts learned while building projects.
