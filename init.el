...
(custom-set-variables
 ...
 '(package-selected-packages
   '(all-the-icons auto-package-update catppuccin-theme company counsel
		   dashboard deadgrep doom-modeline doom-themes
		   helpful ivy-prescient ivy-rich magit
		   nerd-icons-grep no-littering page-break-lines
		   projectile rainbow-delimiters vertico)))
(custom-set-faces
